#!/usr/bin/env python3
import argparse
from machine_learning_finance import back_test_expert, make_env_for, make_inverse_env_for
import pandas as pd
import warnings
...
parser.add_argument("-e", "--env-type", type=str, default="long-short",
                    help="Environment to use: 'long-short, options, inverse")
...
if args.env_type == "long-short":
    env = make_env_for(args.symbol, args.curriciulum, args.tail)
