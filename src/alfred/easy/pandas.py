...
def prepare_data_and_model(category="easy_model",
                           ...
                           augment_func=noop,
                           data_frames=None):
    # todo we desperately need to refactor this into a dataclass or named tuple
    (features_train,
     labels_train,
     model,
     optimizer,
     ...
     scaler,
     scheduler,
     was_loaded) = prepare_data_and_model_raw(augment_func=augment_func,
                                              category=category,
...
def prepare_data_and_model_raw(category="easy_model",
                               model_name="vanilla",
                               model_size=256,
                               files=["data/AAPL_quarterly_directional.csv"],
                               scaler_config=PM_SCALER_CONFIG,
